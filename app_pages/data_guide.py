...
def render():
    ...
    with tabs[1]:
        metrics = pd.DataFrame(
            [
                ["active_charger_count", "양수 실적이 있는 고유 충전기", "설치대수 아님"],
                ["fast_per_1000_ev_stock", "설치 재고×1,000/EV", "2022년까지만"],
                ["fast_per_1000_ev_active", "활성기×1,000/EV", "2023년 이후 공급 보조"],
                ["kwh_per_active_charger", "충전량/활성기", "이용 부담"],
                ["kwh_per_ev", "동월 충전량/동월 EV", "공공급속 의존 수준"],
                ["peak_above_avg_pct", "피크월/월평균−1", "계절 집중도"],
            ...
            [
                {
                    ...
                    "대상": "정책 결정·발표",
                    "탭": "발표·정책 브리핑",
                    "데이터": "YTD 괴리 · 전국 추이 · 2024 시·도 부담 (공공급속)",
                },
                {
                    "순위": "탐색",
                    "대상": "정책·실무 상세",
                ...
                },
                {
                    ...
                    "대상": "급·완속 사업자",
                    "탭": "급·완속 설치 판단",
                    "데이터": "환경부 급·완속 현황(8권역) + 사분면 힌트 + 공공급속 활성기 + 한전 충전소 수",
                },
                {
                    "순위": "3순위",
                    "대상": "전국 기초",
    ...
    with tabs[4]:
        ...
        ratio_rows = [
            {"sido_short": s, "moe_kepco_ratio": v}
