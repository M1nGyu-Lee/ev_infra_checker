...
METRIC_META = {
    ...
    "charge_kwh_sum": {
        ...
        "unit": "kWh",
        "format": ",.0f",
        "help": "환경부 공공충전망에서 발생한 충전량입니다.",
    },
    "active_charger_count": {
        "label": "실제 이용된 충전기 수",
        "unit": "기",
        "format": ",.0f",
        "help": "해당 기간에 충전 실적이 있는 충전기 수입니다.",
    },
    "fast_per_1000_ev_stock": {
    ...
    "fast_per_1000_ev_active": {
        "label": "전기차 1,000대당 실제 이용된 충전기 수",
        "unit": "기",
        "format": ",.2f",
        "help": "전기차 수에 비해 실제 이용된 충전기가 얼마나 있는지입니다. 낮을수록 부족합니다.",
    },
    "kwh_per_active_charger": {
        "label": "실제 이용된 충전기 1기당 충전량",
        "unit": "kWh/기",
        "format": ",.0f",
        "help": "충전기 한 대가 얼마나 바쁜지입니다. 충전량을 실제 이용된 충전기 수로 나눕니다.",
    },
    "kwh_per_ev": {
        "label": "EV당 월 충전량",
        "unit": "kWh/대",
